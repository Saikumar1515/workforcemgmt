...
import com.railse.hiring.workforcemgmt.common.response.ResponseStatus;
...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<Response<Object>> handleResourceNotFoundException(ResourceNotFoundException ex) {
        ResponseStatus status = new SimpleResponseStatus(StatusCode.NOT_FOUND.getCode(), ex.getMessage());
    ...
    public final ResponseEntity<Response<Object>> handleAllExceptions(Exception ex) {
        ResponseStatus status = new SimpleResponseStatus(StatusCode.INTERNAL_SERVER_ERROR.getCode(), "An unexpected error occurred: " + ex.getMessage());
        Response<Object> response = new Response<>(null, null, status);
